...
// RequestOption is an option for the requests made by the knock mgmt API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/knock-mapi-go#readme-requestoptions
...
func WithServiceToken(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.ServiceToken = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.ServiceToken)))
	})
}
