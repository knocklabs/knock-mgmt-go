...
func TestTemplatePreviewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Templates.Preview(context.TODO(), knockmapi.TemplatePreviewParams{
		...
		Recipient: knockmapi.TemplatePreviewParamsRecipientUnion{
		...
		Actor: knockmapi.TemplatePreviewParamsActorUnion{
			OfObjectRecipientReference: &knockmapi.TemplatePreviewParamsActorObjectRecipientReference{
				ID:         "project_1",
				Collection: "projects",
			},
		},
